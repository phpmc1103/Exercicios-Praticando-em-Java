public class Exercicio2 {
    //Você está desenvolvendo um sistema de gerenciamento de estoque que exige que as quantidades
    // dos produtos sejam registradas como números inteiros. Isso ocorre porque um estoque físico não
    // pode conter frações de um item, por exemplo, não faz sentido ter "19.5" unidades de um produto.
